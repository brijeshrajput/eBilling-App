...
import com.bunty.ebillingapp.activities.DetailActivity;
import com.bunty.ebillingapp.activities.NewBillCustomerActivity;
import com.bunty.ebillingapp.activities.SetupPasswordActivity;
import com.bunty.ebillingapp.data.GSTBillingContract;
import com.google.android.material.floatingactionbutton.FloatingActionButton;


public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>, BillAdapter.BillItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(MainActivity.this, NewBillCustomerActivity.class));
            }
        });
